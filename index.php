...
if(isset($_POST['submit'])) {
    ...
    $query = mysqli_query($con, "INSERT INTO tblambulancehiring (BookingNumber, PatientName, RelativeName, RelativeConNum, PatientGender, PatientAge, PatientRelation, HiringDate, HiringTime, AmbulanceType, Address, City, State, Message) VALUES ('$bookingnum', '$pname', '$rname', '$phone', '$patientgender', '$patientage', '$patientrelation', '$hdate', '$htime', '$ambulancetype', '$address', '$city', '$state', '$message')");
...
?>
    ...
    <section id="appointment" class="appointment section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <form class="fromfild_tobooking" action="" method="post" role="form" class="form-control" data-aos="fade-up" data-aos-delay="100">
          ...
          <!-- Patient Age, Gender and Relation -->
          <div class="row" style="padding-top:20px">
            <div class="col-md-4 form-group">
              <input type="number" name="patientage" class="form-control" id="patientage" placeholder="Enter Patient Age" min="0" required>
            </div>
            <!-- Patient Gender -->
            <div class="col-md-4 form-group">
            ...
            <!-- Patient Relation -->
            <div class="col-md-4 form-group ">
              <select name="patientrelation" id="patientrelation" class="form-select" required>
                <option value="">Select Patient Relation</option>
          ...
          <!-- Hiring Date, Time and Ambulance Type -->
          <div class="row">
            ...
            <div class="col-md-4 form-group mt-3">
              <select name="ambulancetype" id="ambulancetype" class="form-select">
                ...
                <option value="6">Mortuary Ambulance</option>
              </select>
            </div>
          </div>
           <div class="row" style="padding-top:20px">
...
.info-box:hover {
  ...
  box-shadow: 0 0 16px 0 rgba(0,174,255,0.25);
